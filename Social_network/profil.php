<?php
    ...
    $req = $bdd->prepare('SELECT id, lastname, age, pseudo, tokenID, gender, birthday, phone, ImgProfile, ImgBanner, email, date_inscription, token FROM profiles INNER JOIN users WHERE tokenID = ? AND token = ?');
